...
1. **Keep the remote command simple.** Single-quoted, no nested double quotes, no `# Deployment — Ollama Forge
...
```
 ...
 variables, no backslashes, no multi-line inline scripts.
